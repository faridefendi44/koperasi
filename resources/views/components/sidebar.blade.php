...
<div id="logoutModal" tabindex="-1" aria-labelledby="modal-title" role="dialog" aria-modal="true"
    id="interestDelete"
    class="hidden overflow-y-auto overflow-x-hidden fixed right-0 lg:left-10 lg:translate-x-1/3 z-50 justify-center items-center w-full md:inset-10 h-[calc(100%-1rem)] max-h-full">
