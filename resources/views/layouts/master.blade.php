                        ...
                        <div class="divide-y  divide-gray-100 dark:divide-gray-700">
                            ...
                            <a href="" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <div class="w-full ps-3">
                                    <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">Status
                                        Dokumen
                                        <span class="font-semibold text-gray-900 dark:text-white">Pending</span>
                                    </div>
                                    <div class=""><span
                                            class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">Mohon
                                            periksa dokumen anda</span></div>
                                    <div class="text-xs text-blue-600 dark:text-blue-500">catatan:
                                        jdhsdk</div>
                                </div>
                            </a>
                        ...
                        $notificationContainer.append(`
                            <a href="${notification.data.url}" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700" data-notification-id="${notification.id}">
                                <div class="w-full ps-3">
                                    ...
                                    <div class="text-xs text-blue-600 dark:text-blue-500">catatan: ${notification.data.note}</div>
                                </div>
                            </a>
                        `);
                    });
