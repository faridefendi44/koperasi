...
@section('content')
    <div class="w-4/5  mx-auto space-y-10">
        <div class="mx-auto h-[39rem] bg-white shadow-lg rounded-lg overflow-y-scroll p-10   my-auto justify-center w-full">
            <h1 class="text-3xl font-semibold">Edit Pinjaman Anggota Koperasi</h1>
            <div class="mt-5">
                <a href="all"
            ...
            <form class="py-10 space-y-5" action="{{route('pinjaman.update', $pinjaman->id)}}" method="POST">
                ...
                <div class="flex justify-around space-x-10">
                    <label for="first_name" class="w-36 font-semibold block mt-3 text-sm text-gray-900 ">Jangka Waktu</label>
                    <input type="number" value="{{$pinjaman->jangka_waktu}}" name="jangka_waktu"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-12"
