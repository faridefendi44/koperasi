...
@section('content')
    <div class="w-4/5  mx-auto space-y-10">
        <div class="mx-auto  bg-white shadow-lg rounded-lg  p-10   my-auto justify-center w-full">
            <h1 class="text-3xl font-semibold">Tambah Simpanan Anggota Koperasi</h1>
            <div class="mt-5">
                <a href="all"
            ...
            <form class="py-10 space-y-5" action="{{route('simpanan.store')}}" method="POST">
                ...
                <div class="flex justify-around space-x-10">
                    <label for="first_name" class="w-36 font-semibold block mt-3 text-sm text-gray-900 ">Simpanan
                        Pokok</label>
                    <input disabled value="50000" type="number" id="nip"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-12"
                ...
                <div class="flex justify-around space-x-10">
                    <label for="first_name" class="w-36 font-semibold block mt-3 text-sm text-gray-900 ">Simpanan
                        Wajib</label>
                    <input value="150000" name="simpanan_wajib" type="number" id="golongan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-12"
