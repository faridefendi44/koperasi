        ...
        <div class="">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 bg-[#D9D9D9]">
                    ...
                    <tbody>
                        @foreach ($angsuransPaginated->unique('id_pinjaman') as $item)
                            @php
                                $totalAngsuran = $angsuransPaginated
                            ...
                            <tr class="bg-[#D9D9D9] border-b">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex space-x-3">
                                        <a href="{{ route('angsuran.show', $item->pinjaman->id) }}"
