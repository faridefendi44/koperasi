    ...
    <div class="w-4/5  mx-auto space-y-10">
        <div class="mx-auto h-[39rem] bg-white shadow-lg rounded-lg overflow-y-scroll p-10   my-auto justify-center w-full">
            ...
            <form class="py-10 space-y-5" action="">
                ...
                <div class="flex justify-around space-x-10">
                    <label for="countries" class="w-36 block mb-2 text-sm font-semibold mt-3 text-gray-900 ">Nomor Anggota</label>
                    <select id="countries" class="bg-gray-50 h-12 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                      <option selected>Pilih nomor anggota koperasi</option>
                ...
                <div class="flex justify-around space-x-10">
                    <label for="first_name" class="w-36 font-semibold block mt-3 text-sm text-gray-900 ">Simpanan Wajib</label>
                    <input type="text" id="golongan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 h-12"
                        placeholder="Masukkan nominal simpanan wajib" required />
                </div>
